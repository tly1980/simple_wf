  ...
  return {
    ...
    init: {
      ...
      desktop: function() {
        ...
        d.on('click', 'div.icon', function(ev){
          var app_id = $(this).attr('app_id');
          this.blur();

          if (app_id !== undefined) {
              APP_PORTAL.start_app_instance(app_id);
          }          
        });
        ...
        d.on('click', '#dock a', function() {
          ...
          var $btn = $(this);
          var $window = $('.window[win_id="' + win_id + '"]');
          ...
          if ($window .is(':visible')) {
            ...
            // Bring window to front.
            JQD.util.window_flat();
            $window.addClass('window_stack').show();
          }
        ...
        d.on('click', 'a.window_close', function() {
          ...
          var win_id = $(this).attr('win_id');
          console.log('a.window_close.click: win_id', win_id);
          APP_PORTAL.shutdown_app_instance(win_id);
        });
      ...
      wallpaper: function() {
        ...
        if ($('#desktop').length) {
          $('body').prepend('<img id="wallpaper" class="abs" src="https://cdn.brandsexclusive.com.au/site_media/img/homepage/homepage_lake.jpg" />');
        }
      }
    },
    util: {
